...
class Proc():
    ...
    def get_time_ranges(self, tracker):
        ...
        for j in numpy.arange(0.000, float(args.duration), 0.005):
            ...
            #print "=====TESTS===="
            #print "Voicing = ", self.tracker[i][1]
            ...
            if args.noise == True :
                ...
                spectrum = numpy.absolute(numpy.fft.rfft(frame))
                ...
                nb_4_5 = numpy.mean(spectrum[index_4:index_5])
                nb_5_6 = numpy.mean(spectrum[index_5:index_6])
                nb_6_7 = numpy.mean(spectrum[index_6:index_7])
                nb_7_8 = numpy.mean(spectrum[index_7:index_8])
