...
parse.add_argument('--samplerate', '-s', action='store_const', default=16000)
...
class Proc():
    def __init__(self):
        self.tracker=[]
        self.samplerate = args.samplerate #16000 #SET SAMPLERATE
    ...
    def get_time_ranges(self, tracker):
        ...
        print "LEN NEW TRACKER = ", len(new_tracker)
        ...
        for j in numpy.arange(0.000, float(args.duration), 0.005):
            ...
            print "START SAMP = ", start_samp
            print "CURRENT SAMP = ", current_samp
            print "END SAMP = ", end_samp
    ...
    def create_window(self, start, peak, end, resampled):
        ...
        print "NEw win legnth = ", len(new_window)
        return new_window
